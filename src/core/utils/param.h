...
struct Parameters {
    ...
    static int getTries() { return Parameters::tries; }
    static void setTries(int tries) { Parameters::tries = tries; }

    static int maxInsert() { return Parameters::max_insert; }
    static void setMaxInsert(int maxInsert) { Parameters::max_insert = maxInsert; }

    static int lazyIterationsSwapRatio() { return Parameters::lazy_iterations_swap_ratio; }
    static void setLazyIterationsSwapRatio(int lazyIterationsSwapRatio) { Parameters::lazy_iterations_swap_ratio = lazyIterationsSwapRatio; }

    static int executionTime() { return Parameters::execution_time; }
    static void setExecutionTime(int executionTime) { Parameters::execution_time = executionTime; }

    static int getSleep() { return Parameters::sleep; }
    static void setSleep(int sleep) { Parameters::sleep = sleep; }

    static int candidateSkip() { return Parameters::candidate_skip; }
    static void setCandidateSkip(int candidateSkip) { Parameters::candidate_skip = candidateSkip; }

    static int lazyTries() { return Parameters::lazy_tries; }
    static void setLazyTries(int lazyTries) { Parameters::lazy_tries = lazyTries; }

    static int tabuSize() { return Parameters::tabu_size; }
    static void setTabuSize(int tabuSize) { Parameters::tabu_size = tabuSize; }
   ...
   private:
    ...
    /*Metaheuristic*/
    static int tries;
    static int max_insert;
    static int lazy_iterations_swap_ratio;
    static int execution_time;
    static int sleep;
    static int candidate_skip;
    static int lazy_tries;
